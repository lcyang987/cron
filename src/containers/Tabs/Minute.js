...
import Index from '@/components/Tabs/Minute';

class ContainersMinute extends React.Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMinute);