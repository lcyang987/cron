...
import Index from '@/components/Tabs/Second';

class ContainersSecond extends React.Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersSecond);