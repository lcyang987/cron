...
import Index from '@/components/Tabs/Hour';

class ContainersHour extends React.Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersHour);